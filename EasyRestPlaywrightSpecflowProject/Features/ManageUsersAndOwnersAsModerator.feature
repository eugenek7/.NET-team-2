...
@smoke
Scenario Outline: Ban the first active user and check that user is banned.
	...
	@smoke
Scenario Outline: Unban the first banned user and check that the user is unbanned.
	Given I go to Easy rest page
	And I log in to my account with '<email>' and '<password>'
	And I go to Users tab
	And I go to Banned tab
